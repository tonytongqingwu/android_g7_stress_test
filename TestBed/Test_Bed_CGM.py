...
class Test_Bed_CGM(Common_Utilities):
    ...
    def launch_dexcom_app(self):
        ...
        print("_________________________")
        os.system(
            "adb -s " + self.adb_id + " shell am start -n com.dexcom.g6/com.dexcom.cgm.activities.AppCompatabilityActivity")
        sleep(10)
    ...
    def settings_alerts(self):
        ...
        try:
            ...
            self.driver.find_element_by_xpath(
                "//android.widget.LinearLayout[contains(@resource-id,'id_settings_alerts')]").click()
    ...
    (new UiSelector().textMatches(\"" + highVal + "\").instance(0))").click()
            ...
            self.driver.find_element_by_android_uiautomator(
                "new UiScrollable(new UiSelector().scrollable(true).instance(0)).scrollIntoView(new UiSelector().textMatches(\"" + riseRateVal + "\").instance(0))").click()
            ...
            fallRateVal = "3"
            self.driver.find_element_by_android_uiautomator(
                "new UiScrollable(new UiSelector().scrollable(true).instance(0)).scrollIntoView(new UiSelector().textMatches(\"" + fallRateVal + "\").instance(0))").click()
        ...
        try:
            ...
            try:
                ...
                while True:
                    ...
                    delete_icon = self.driver.find_element_by_xpath(
                        "//android.widget.ImageView[contains(@resource-id,'id_delete')]")
                    delete_icon.click()
                    sleep(2)
                    i += 1
