...
class Test_Bed_Youtube(Common_Utilities):
    ...
    def operate_Youtube(self, dynamic_flag, dynamic_video_play_time):
        ...
        try:
            ...
            lgr_handle.info("Video will Start playing on YouTube app related to : '" + searchVal + "'" + " for '" + str(
                timeOut) + "' seconds")
            print("Video will Start playing on YouTube app related to : '" + searchVal + "'" + " for '" + str(
                timeOut) + "' seconds")
            sleep(timeOut)
            ...
            lgr_handle.info(
                "Played video on YouTube app related to : '" + searchVal + "'" + " for '" + str(timeOut) + "' seconds")
            print(
                "Played video on YouTube app related to : '" + searchVal + "'" + " for '" + str(timeOut) + "' seconds")
