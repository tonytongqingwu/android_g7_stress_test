...
class Test_Bed_Chrome_Browser(Common_Utilities):
    ...
    def operate_Chrome_Browser(self):
        ...
        sleep(2)
        try:
            os.system("adb -s "+self.adb_id+" shell am start -n com.android.chrome/com.google.android.apps.chrome.Main -d "+self.config_params.get("Browser_URL_1"))
            ...
            os.system("adb -s "+self.adb_id+" shell am start -n com.android.chrome/com.google.android.apps.chrome.Main -d "+self.config_params.get("Browser_URL_2"))
