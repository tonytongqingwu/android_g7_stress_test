...
class Test_Bed_LaunchGame(Common_Utilities):
    ...
    def launch_Game(self):
        ...
        try:
            ...
            sleep(2)
            os.system(
                "adb -s " + self.adb_id + " shell am start -n com.kiloo.subwaysurf/com.sybogames.chili.multidex.ChiliMultidexSupportActivity")
            sleep(8)
            ...
            sleep(4)
            os.system(
                "adb -s " + self.adb_id + " shell am start -n com.king.candycrushsaga/com.king.candycrushsaga.CandyCrushSagaActivity")
            sleep(8)
            lgr_handle.info("Press Back Button")
            print("Press Device BackButton")
            for i in range(0, 3):
