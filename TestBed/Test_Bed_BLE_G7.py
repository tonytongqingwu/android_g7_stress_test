...
class Test_Bed_BLE_G7(Common_Utilities):
    ...
    def g7_Events_Blood_Glucose(self):
        ...
        try:        
            ...
            bloodGlucose="20"
            self.driver.find_element_by_xpath(".//android.widget.EditText").send_keys(bloodGlucose)#com.dexcom.g7:id/id_bg_meter_value_edit_text
            print("Blood Glucose Value entered",bloodGlucose)
            lgr_handle.info("Blood Glucose Value entered")            
            sleep(4)
            self.driver.find_element_by_xpath("//android.widget.Button[@text='Save']").click()#com.dexcom.g7:id/id_bg_save_button
            sleep(4)
            self.driver.find_element_by_xpath("//android.widget.Button[@text='Confirm']").click()#com.dexcom.g7:id/id_confirmation_confirm_button
            sleep(4)
    ...
    (new UiSelector().textContains(\""+highVal+"\").instance(0))").click()
            ...
            riseFastVal="2.2"
            self.driver.find_element_by_android_uiautomator("new UiScrollable(new UiSelector().scrollable(true).instance(0)).scrollIntoView(new UiSelector().textContains(\""+riseFastVal+"\").instance(0))").click()
            ...
            fallRateVal="5.2"
            self.driver.find_element_by_android_uiautomator("new UiScrollable(new UiSelector().scrollable(true).instance(0)).scrollIntoView(new UiSelector().textContains(\""+fallRateVal+"\").instance(0))").click()
