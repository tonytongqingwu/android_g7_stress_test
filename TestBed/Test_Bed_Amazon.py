...
class Test_Bed_Amazon(Common_Utilities):
    ...
    def operate_Amazon(self):
        ...
        print("-------------------------------------")
        os.system("adb -s "+self.adb_id+" shell am start -n com.amazon.mShop.android.shopping/com.amazon.mShop.home.HomeActivity")
        lgr_handle.info("\n")
        ...
        try:
            ...
            #self.driver.find_element_by_xpath(".//android.widget.TextView").clear()
            self.driver.find_element_by_id("com.amazon.mShop.android.shopping:id/chrome_action_bar_search_icon").click()
            sleep(5)
            ...
            self.driver.find_element_by_id("com.amazon.mShop.android.shopping:id/chrome_search_hint_view").click()
            # sleep(5)
            # self.driver.find_element_by_xpath(".//android.widget.TextView").clear()
            # sleep(5)
            # self.driver.find_element_by_xpath(".//android.widget.EditText").clear()
            ...
            # print("Click on Search  ")
            # self.driver.find_element_by_xpath(".//android.widget.EditText").clear()
            self.driver.find_element_by_id("com.amazon.mShop.android.shopping:id/rs_search_src_text").click()
            sleep(5)
