...
class Test_Bed_YouTubeMusic(Common_Utilities):
    ...
    def operate_YouTubeMusic(self, dynamic_flag, dynamic_music_play_time):
        ...
        print("-------------------------------------")
        os.system(
            "adb -s " + self.adb_id + " shell am start -n com.google.android.apps.youtube.music/com.google.android.apps.youtube.music.activities.MusicActivity")
        lgr_handle.info("\n")
        ...
        try:
            ...
            print("Music will Start playing, song searched as '" + songVal + "'" + " will be played for '" + str(
                timeOut) + "' seconds")
            lgr_handle.info(
                "Music will Start playing, song searched as '" + songVal + "'" + " will be played for '" + str(
                    timeOut) + "' seconds")
            sleep(timeOut)
            ...
            self.driver.find_element_by_id(
                "com.google.android.apps.youtube.music:id/player_control_play_pause_replay_button").click()
            ...
            print("Played Music on YouTubeMusic, song searched as '" + songVal + "'" + " played for '" + str(
                timeOut) + "' seconds")
            lgr_handle.info("Played Music on YouTubeMusic, song searched as '" + songVal + "'" + " for '" + str(
                timeOut) + "' seconds")
